...
const DATA: Dictionary = {
	...
	&"l08": {m = [&"imp_intro", &"imp_intro"],
		w = [["m1", 0, "m0", 0], ["m0", 1, "m1", 0], ["m0", 0, "g", 0]],
		p = [["m0", 1, "A"], ["m1", 1, "B"]]},
	&"l09": {m = [&"imp_intro", &"imp_intro", &"and_intro", &"imp_elim"],
	...
	&"l11": {m = [&"or_elim", &"or_intro", &"or_intro"],
		w = [["s0", 0, "m0", 0],
			["m0", 1, "m1", 0], ["m1", 1, "m0", 1],
			["m0", 2, "m2", 0], ["m2", 0, "m0", 2],
			["m0", 0, "g", 0]], p = []},
	&"l12": {m = [&"imp_intro", &"or_elim", &"and_elim", &"imp_elim", &"imp_elim"],
		w = [["s0", 0, "m2", 0],
			["m0", 1, "m1", 0],
	...
	&"l13": {m = [&"false_elim"],
		w = [["s0", 0, "m0", 0], ["m0", 0, "g", 0]], p = []},
	&"l14": {m = [&"imp_intro", &"imp_intro", &"imp_elim", &"imp_elim"],
		w = [["s0", 0, "m2", 0], ["m1", 1, "m2", 1],
			["m0", 1, "m3", 0], ["m2", 0, "m3", 1],
			["m3", 0, "m1", 0], ["m1", 0, "m0", 0], ["m0", 0, "g", 0]],
		p = [["m0", 1, "B > false"], ["m1", 1, "A"]]},
	&"l15": {m = [&"and_elim", &"imp_elim", &"false_elim"],
		w = [["s0", 0, "m0", 0],
			["m0", 1, "m1", 0], ["m0", 0, "m1", 1],
			["m1", 0, "m2", 0], ["m2", 0, "g", 0]], p = []},
	&"l16": {m = [&"tnd"],
		w = [["m0", 0, "g", 0]], p = []},
	&"l17": {m = [&"tnd", &"or_elim", &"imp_elim", &"or_intro", &"or_intro"],
		w = [["m0", 0, "m1", 0],
			["s0", 0, "m2", 0], ["m1", 1, "m2", 1], ["m2", 0, "m3", 0], ["m3", 1, "m1", 1],
			["m1", 2, "m4", 0], ["m4", 0, "m1", 2],
			["m1", 0, "g", 0]], p = []},
}
